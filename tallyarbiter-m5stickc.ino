...
const char * networkSSID = "CP-Production";
const char * networkPass = "%AVL-22lemons+";
...
IPAddress clientIp(10, 101, 1, 54); // Static IP
IPAddress subnet(255, 255, 0, 0); // Subnet Mask
IPAddress gateway(10, 101, 0, 1); // Gateway

//Tally Arbiter Server
const char * tallyarbiter_host = "10.102.1.10"; //IP address of the Tally Arbiter Server
